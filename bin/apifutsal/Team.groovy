...
class Team {
    ...
    static hasMany = [imagesTeam:ImageTeam, players: Player, reviewsTeam: ReviewTeam, matchRecords: MatchRecord]
    ...
    static constraints = {
        ...
        email size: 1..50, email: true, blank: false, nullable: false, unique: true
