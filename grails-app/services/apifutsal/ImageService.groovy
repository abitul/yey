...
def result 
    ...
    def showData(params) {
        try{
            ...
            result = params.searchValue == "" ? Image.listOrderByLastUpdate(order: "desc") : Image.findAllByImageNameIlike("%${params.searchValue}%",[max: params.int("max"), sort: "imageName", order: "desc", offset: offset])
        }catch(e){
